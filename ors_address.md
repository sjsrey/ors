...
We hold it in such high regard as science delivered on the noble goals of:
...
Now take the centroid of each domain polygon as a point representing the core of that domain.[^core]
...
Combined, these results raise doubts about the legitimacy of the open access journal as a repository for the state of scientific knowledge as, in this case, acceptance of patently false findings was far from the exception.[^bohannon] [^bohannon]:

footnote

Questions of selectivity bias in @Bohannon:2013kx have been raised since the sample included only open access journals and not journals published under the traditional model.

---
In addition to the problem of quality control in open access journals, another major challenge that arises in captured science is the roadblocks to reproducibility and the weakening of science's self-correction mechanism.
...
Uncovering those mistakes is also not easy, especially in our current publishing system.
...
Publication pressures exacerbate this by leaving scholars precious time to fully document the research process that goes into the final publication of the manuscript.
